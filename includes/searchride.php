...
<script>
    ...
    + origin + " and " + destination);
        ...
        $('#outputresults').html("It is " + distance.text + " miles from " + origin + " to " + destination + "<br/>Total earning per passenger is: <strong>$" + pay +"</strong>"); //var distance = response.rows[0].elements[0].distance;
    }
    }
    }
