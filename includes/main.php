...
<section class="container-fluid" id="main_sec4">
    ...
    <div class="row text-xs-center">
        <div class="col-lg-8 offset-lg-2">
            <h5>Moove is a ride-sharing application where the driver can host the <br>ride and the passenger(s) can join the host and share the ride.</h5>
        </div>
    </div>
    <br>
    <div class="row text-xs-center">
        <div class="col-lg-8 offset-lg-2">
            <h4><strong>How Moove works?</strong></h4>
            
            <img src="/images/car.jpg" alt="Carpool Logo" width="120" height="120">
        </div>
        <hr class="centered">
    </div>
    ...
    <div class="row text-xs-center">
        ...
        <div class="col-xs">
            ...
            <p><strong>
                ...
                Select/Provide Vehicle Type/Model<br>
