	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title text-xs-center" id="myModalLabel">Become an Moove Member</h4>
			</div>
							...
							<div class="col-lg-8 offset-lg-2 text-xs-center">
								<form name="signup" id="signup" method="post" action="requests/signup-request.php">
									...
									<div class="row control-group form-inline">
										<div class="form-group col-xs-12 floating-label-form-group controls">
											<label for="checkbox"><input type="checkbox" id="signup_checkbox"> I’d like to receive coupons, promotions, surveys, and updates via email about Moove and its partners.</label>
										</div>
									</div>
									<div class="row">
